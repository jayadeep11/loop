...
const Sidebar = () => {
  ...
  return (
    <motion.div
      className="sidebar hidden fixed left-0 top-1/2 transform -translate-y-1/2 z-10 text-violet-400 md:flex items-center bg-transparent justify-center border-zinc-700 rounded-2xl w-[80px] transition-all duration-500"
